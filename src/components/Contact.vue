                ...
                <div class="row mt--50 mt_md--40 mt_sm--40 mt-contact-sm">
                    <div class="col-lg-5">
                        <div class="contact-about-area">
                            <div class="thumbnail">
                                <img src="/images/contact/contact1.png" alt="contact-img">
                            </div>
                            <div class="title-area">
                                <h4 class="title">Poologarasa Thamilselven</h4>
                            ...
                            <div class="social-area">
                                ...
                                <div class="social-icone">
                                    <a href="https://web.facebook.com/thamil.selven.129" target="_blank"><i data-feather="facebook"></i></a>
                                    <a href="https://www.linkedin.com/in/thamilselven/" target="_blank"><i data-feather="linkedin"></i></a>
                                    <a href="https://www.instagram.com/sp.thamilselven/" target="_blank"><i data-feather="instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
