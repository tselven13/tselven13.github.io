                ...
                <div class="container">
                    <div class="row row--30 align-items-center">
                                    ...
                                    <div class="col-lg-6 col-xl-6 col-md-6 col-sm-6 col-12">
                                        <div class="social-share-inner-left">
                                            ...
                                            <ul class="social-share d-flex liststyle">
                                                ...
                                                <li class="linkedin"><a href="https://www.linkedin.com/in/thamilselven/" target="_blank"><i data-feather="linkedin"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="order-1 order-lg-2 col-lg-5">
                            <div class="thumbnail">
                                <div class="inner">
                                    <img src="/images/slider/tselven.png" alt="Personal Portfolio Images">
                                </div>
                            </div>
                        </div>
                    </div>
